...
<section class="flex gap-4 flex-col top-0">
    ...
    <section class="HEADER_CONTAINER flex justify-between">
        ...
        <button class="{button_ghost} font-semibold">Print</button>
    </section>
    ...
    <section class="PANE_CONTAINER">
        <section class="grid gap-4" style="grid-template-columns: 5fr 2fr;">
            <section class="LEFT_PANE p-8 bg-white rounded-md">
                <h2 class="text-2xl font-bold">BBB-01-000487</h2>
                <div class="pt-1 pb-2 text-gray-600 border-b border-gray-200">Tembalang, Semarang, Jawa Tengah 50173</div>
                ...
                <section class="grid grid-cols-2">
                    ...
                    <div class="py-4 border-b border-gray-200">
                        ...
                        <div class="text-gray-800">089636635266</div>
                    </div>
                    ...
                    <div class="col-span-2 py-4 border-b border-gray-200">
                    ...
                    <section class="grid gap-2" style="grid-template-columns: 1fr 5fr;">
                        <section class="TIMELINE relative">
                            <svg class="w-full h-full fill-indigo-600 stroke-indigo-600" xmlns="http://www.w3.org/2000/svg">
                                {#each {length:4} as _,i}
                                    ...
                                    <circle cx="20" class={i == 3 ? "fill-gray-400 stroke-gray-400" : "fill-indigo-600 stroke-indigo-600"} cy={cr + 4 + off} r={cr}/>
                                    {#if i !== 3}
                        ...
                        <section class="flex flex-col gap-4">
                            <div>
                                ...
                                <div class="text-sm text-gray-600 ">08:34, 12 May 2024</div>
                            </div>
                            <div>
